...
export default function AddNew() {
  ...
  // Handling disabling options in end time list that are smaller than start time
  const disable = (e) => {
    var id = "";
          ...
          <form className="modal-form">
            ...
            <div className="radio">
              <input
                ...
                name="event_type"
                value={true}
                onChange={(e) => setAllDay((a) => e.target.value)}
              />
              All Day
              <input
                className="radio-btn"
            ...
            <div className="btns">
              ...
              <button disabled={!location || !name} onClick={handleNew}>
                Add
              </button>
            </div>
          </form>
